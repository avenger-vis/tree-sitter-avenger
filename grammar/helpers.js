...
export const DSL_KEYWORDS = [
  ...
  "interval", "slot", "channel", "output", "export", "match", "set", "clear",
  "insert", "replace", "upsert", "patch", "delete", "toggle", "cursor", "to",
  "private", "public", "nullable", "at", "replacing", "scopes", "from", "scene",
  "within", "shared", "free", "as",
